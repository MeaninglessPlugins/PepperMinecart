 ...
 * 漏斗矿车：取下还原漏斗物品内容
 */
public class HopperCartFeature extends VanillaCartFeature {

    public HopperCartFeature(Material material, EntityType entityType) {
    ...
    protected void transferContents(Entity newEntity, ItemStack placedItem, FeatureContext ctx) {
        ...
        storage.getInventory().setContents(container.getInventory().getContents());
    }
